...
up = 565 + pw * 0.5;
vp = 425 + ph * 0.5;
ipw = floor(up-pw/2):floor(up+pw/2)-1;
iph = floor(vp-ph/2):floor(vp+ph/2)-1;
...
for k = 2 : 145%numFrames
    ...
    mse = histogramComparison(img, ip, particles); %meanSquaredError(img, ip, [up vp], [particles_x particles_y]);
    sigma_i = 0.02;
